...
const float CH2_DELTA_SPIKE_RATIO = 1.8f;
const float CH3_DELTA_SPIKE_RATIO = 3.0f;

const unsigned long CH2_MIN_RAW_DELTA = 40;
const unsigned long CH3_MIN_RAW_DELTA = 100;

const float DELTA_AVG_SMOOTHING = 0.04f;
...
void analyzeSample() {
  ...
  // =====================================================
  // POT-INDEPENDENT DELTA SPIKE TRACKING
  // =====================================================
  // Update deltaAverage from raw delta only.
  // This does not use the sensitivity pot.
  ...
  bool playCh2 = (delta >= CH2_MIN_RAW_DELTA) && (deltaSpikeRatio >= CH2_DELTA_SPIKE_RATIO);
  bool playCh3 = (delta >= CH3_MIN_RAW_DELTA) && (deltaSpikeRatio >= CH3_DELTA_SPIKE_RATIO);
